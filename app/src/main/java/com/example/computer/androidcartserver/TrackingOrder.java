...
import com.example.computer.androidcartserver.Common.DirectJSONParser;
...
public class TrackingOrder extends FragmentActivity implements OnMapReadyCallback,
                ...
                try {
                    ...
                    mServices.getDirections(yourLocation.latitude+","+yourLocation.longitude,
                            ...
                            .enqueue(new Callback<String>() {
                                @Override
                                public void onResponse(Call<String> call, Response<String> response) {
                                    new  ParkTask().execute(response.body().toString());
                                }
    ...
    private boolean checkPlayServices() {
        ...
        if (resultCode!=ConnectionResult.SUCCESS)
        {
            ...
            {
                Toast.makeText(TrackingOrder.this,"This device is not supporting",Toast.LENGTH_SHORT).show();
                finish();
            }
            return false;
        }
    ...
    private class ParkTask extends AsyncTask<String,Integer,List<List<HashMap<String,String>>>> {
      ProgressDialog mDialog =  new ProgressDialog(TrackingOrder.this);
        ...
        protected List<List<HashMap<String, String>>> doInBackground(String... strings) {
            ...
            try {
                ...
                DirectJSONParser parser = new DirectJSONParser();
